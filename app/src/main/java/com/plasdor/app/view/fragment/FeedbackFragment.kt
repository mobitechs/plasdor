...
import com.plasdor.app.utils.openClearActivity
...
class FeedbackFragment : Fragment(), ApiResponse {

    lateinit var rootView:View
    lateinit var txtEmail: TextInputEditText
    lateinit var txtFeedback:TextInputEditText
    ...
    private fun initView() {
        ...
        txtFeedback = rootView.findViewById(R.id.txtFeedback)!!
        ...
        btnSubmit.setOnClickListener {
            if(txtFeedback.text.toString().equals("")){
                requireContext().showToastMsg("Please Enter Feedback")
            }else{
                val method = "addFeedback"
                val jsonObject = JSONObject()
                try {
                    jsonObject.put("method", method)
                    jsonObject.put("userId", userId)
                    jsonObject.put("email", email)
                    jsonObject.put("feedback", txtFeedback.text.toString())
