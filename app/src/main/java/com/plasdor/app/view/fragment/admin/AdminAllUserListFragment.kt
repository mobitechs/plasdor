...
class AdminAllUserListFragment  : Fragment() {

    lateinit var viewModelUser: AdminViewModel
    lateinit var listAdapter: AdminAllUserAdapter
    ...
    override fun onCreateView(
        ...
        rootView = inflater.inflate(R.layout.fragment_admin_all_user_list, container, false)
        initView()
        return rootView
    }
    ...
    private fun setupRecyclerView() {
        ...
        viewModelUser.adminAllUserList()

        viewModelUser.allUserListItems.observe(requireActivity(), Observer {
            listItems = it
            listAdapter.updateListItems(it)
        })

        listAdapter = AdminAllUserAdapter(
            requireActivity()
        )
