...
import com.plasdor.app.adapter.AdminPendingUserListAdapter
...
class AdminPendingUserListFragment : Fragment() {

    lateinit var viewModelUser: AdminViewModel
    lateinit var listAdapter: AdminPendingUserListAdapter
    ...
    override fun onCreateView(
        ...
        rootView = inflater.inflate(R.layout.fragment_admin_pending_user_list, container, false)
        initView()
        return rootView
    }
    ...
    private fun setupRecyclerView() {
        ...
        fetchList()
        listAdapter = AdminPendingUserListAdapter(
            requireActivity()
        )
    ...
    private fun fetchList() {
        viewModelUser.getAllPendingUserList()

        viewModelUser.allPendingUserList.observe(requireActivity(), Observer {
            listItems = it
