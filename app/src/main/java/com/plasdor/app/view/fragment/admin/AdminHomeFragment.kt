...
class AdminHomeFragment : Fragment(), MerchantHomeMenuClickListener {
    ...
    private fun getMerchantMenuList() {
        ...
        listItems.add(HomeMenuItems("2","All Orders",R.drawable.orders))
        listItems.add(HomeMenuItems("3","All Merchants",R.drawable.merchant))
        listItems.add(HomeMenuItems("4","All Users",R.drawable.user))
    ...
    override fun selectProduct(item: HomeMenuItems, position: Int) {
        (context as AdminHomeActivity).openPage(item.menuId)
    }
